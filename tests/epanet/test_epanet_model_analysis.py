...
def test_network():
    """
    python3.7 -m graphflow epanet "/home/michal/Documents/io2019/graph-flow/examples/epanet/example_epanet_network.inp" earthquake --epicenter_x 25000 --epicenter_y 5000 --magnitude 8.0 --depth 1000
    :return:
    """
...
# def test_maximum_flow(test_network):  # TODO
